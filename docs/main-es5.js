...
var DataService = /** @class */ (function () {
    ...
    // --------- ERROR MESSAGING --------- //
    DataService.prototype.getErrorMessage = function () {
        return this.message;
    };
    DataService.prototype.updateErrorMessage = function (message) {
    ...
    DataService.prototype.createItem = function (dataItem, datasetName) {
        ...
        return this.http.post(this.host + "/" + datasetName, dataItem)
            ...
            _this.messageSource.next(err.error);
...
var MainPageHeaderComponent = /** @class */ (function () {
    function MainPageHeaderComponent(dataService) {
    ...
    MainPageHeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.dataService.getErrorMessage().subscribe(function (errorMessage) {
    ...
    MainPageHeaderComponent.ctorParameters = function () { return [
